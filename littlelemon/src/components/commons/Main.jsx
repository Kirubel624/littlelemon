  ...
  return (
    ...
    <section className='bg-[#495E57] w-[100vw] flex justify-between -red-900 items-center px-[20vw] py-10'>
     <div className='lg:w-[25vw] w-full  -green-900 flex flex-col justify-center item'>
        ...
        <div className='static  -red-900 flex justify-center items-'>
          <img className='lg:block hidden w-[300px] rounded-xl object-cover h-[335px] absolute right-[20vw] top-[10rem]' src="https://res.cloudinary.com/dvqawl4nw/image/upload/v1701453328/pbygrd9a1r6puekc3x2y.jpg"/>
        </div>
    </section>
    ...
    <section className='bg-[#495E57] py-24 px-[20vw]'>
      ...
      <div className=' grid md:grid-cols-2 grid-cols-1 xl:grid-cols-4 gap-4 justify-around items-center pt-12'>
        <TestimonyCard stars={5} review="Great food and hospitality" name="Amy" image="https://res.cloudinary.com/dvqawl4nw/image/upload/v1700576200/lupkrg0d6s9zksiqg9fg.avif"/>
        <TestimonyCard stars={4} review="Great food and hospitality" name="Maria" image="https://res.cloudinary.com/dvqawl4nw/image/upload/v1700576198/z8kjqwsl82lthhhdljc2.avif"/>
        <TestimonyCard stars={4.3} review="Great food and hospitality" name="Silvia" image="https://res.cloudinary.com/dvqawl4nw/image/upload/v1700576196/f2uibet1zsaah1eezqit.avif"/>
        <TestimonyCard stars={4.7} review="Great food and hospitality" name="John" image="https://res.cloudinary.com/dvqawl4nw/image/upload/v1701541341/vlad1gswy3vlxentw9al.jpg"/>
      </div>

    </section>
    <section className='py-24 px-[20vw] flex'>
      <div className='pr-6'><h1 className='font-markazi text-[3.25rem] leading-[0.8]'>Little Lemon</h1>
...
Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. </p></div>
    <div className='w- '>
      <img className=' hidden lg:block object-cover h-full' src="https://res.cloudinary.com/dvqawl4nw/image/upload/v1701684970/jnatcrxa3sxjppcjpeeh.png"/>
    </div>
    </section>
</main>
    </>
